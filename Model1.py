...
from Sub_Functions.Evaluate import Evaluation_Metrics1, main_est_parameters_mul
...
def CNN_1(x_train1, x_test1, y_train1, y_test1, x_train2, x_test2, y_train2, y_test2, x_train3, x_test3, y_train3,
    ...
    c_out1 = main_est_parameters_mul(C_test, pred)
