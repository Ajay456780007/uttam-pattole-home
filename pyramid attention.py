...
class Feature_Pyramid_Attention_1D:
    ...
    def downsample(self):
        max_pool_1 = MaxPooling1D(pool_size=2)(self.layer)
        ...
        max_pool_2 = MaxPooling1D(pool_size=2)(conv7_1)
        ...
        max_pool_3 = MaxPooling1D(pool_size=2)(conv5_1)
